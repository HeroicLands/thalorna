...
- **[[place-pssshrines|The Pass-Shrines]]**—a chain of Varnaka temples built at the high points of the caravan roads, where travelers stop to leave offerings before attempting the descent. The shrines are maintained by a specialized brahmin sub-caste whose members live year-round at altitudes that would kill an unaccustomed lowlander within a week.
