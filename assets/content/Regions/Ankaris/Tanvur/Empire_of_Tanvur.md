...
The dynastic record the imperial archives can document begins around **2500 BF** and runs from there through more than a dozen dynasties, each of which represents a reassignment of the Mandate from a decaying house to a more correctly-classified successor. The [[lore-celestlrdr|Celestial Order]] traces the same line very much further, to the Great Convergence at the zero of the Celestial Calendar; the empire holds both accounts at once and has a doctrine for doing so, set out in [[lore-clndrstrlgy|Calendar and Astrology]]. The most recent major reassignment is several centuries old; the current dynasty is in a period that historians (including its own official historians) describe as mature—past the vigor of its founding centuries, not yet in the terminal corruption that would warrant a Mandate-transfer, but increasingly subject to the structural strains that characterize late-dynastic decline.
