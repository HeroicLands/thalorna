...
The desert borders the [[place-khzryndsrtrgn|Khazryn Desert]] to the north and east (the two regions shade into one another along a long, ill-defined frontier), the [[affiliation-cnfdrtnhrdnstts|Haradian States]] to the northwest, and the lands of [[place-vedyarargn|Vedyara]] to the southeast. To the southwest lies the vast region of [[place-takheperurgn|Ta'Kheperu]], a constant source of both commerce and conflict; between the two lies [[place-khstmhttrgn|Khaset-Mehtet]], the disputed desert-march the empire garrisons and the western clans contest.
