...
sohl:
  items:
    ...
    - { model: sohl-sohl-skill-thro, system: { masteryLevelBase: 38 } }
    ...
    - { model: sohl-sohl-skill-guil, system: { masteryLevelBase: 34 } }
    - { model: sohl-sohl-skill-trak, system: { masteryLevelBase: 34 } }
    - { model: sohl-sohl-skill-lock, system: { masteryLevelBase: 30 } }
    - { model: sohl-sohl-skill-ridg, system: { masteryLevelBase: 34 } }
    ...
    - { model: skill-elvndrlng, system: { masteryLevelBase: 58 } }
  system:
    body:
      structure:
        zones:
