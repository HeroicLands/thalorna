...
sohl:
  items:
    ...
    - { model: sohl-sohl-skill-brew, system: { masteryLevelBase: 46 } }
    ...
    - { model: sohl-sohl-skill-mrcn, system: { masteryLevelBase: 30 } }
    ...
    - { model: skill-elvndrlng, system: { masteryLevelBase: 50 } }
  system:
    body:
      structure:
        zones:
