...
sohl:
  items:
    ...
    - { model: sohl-sohl-skill-guil, system: { masteryLevelBase: 62 } }
    - { model: sohl-sohl-skill-dscr, system: { masteryLevelBase: 58 } }
    - { model: sohl-sohl-skill-script, system: { masteryLevelBase: 52 } }
    ...
    - { model: sohl-sohl-skill-mrcn, system: { masteryLevelBase: 36 } }
    ...
    - { model: skill-elvndrlng, system: { masteryLevelBase: 72 } }
    - { model: skill-vylarilng, system: { masteryLevelBase: 68 } }
    - { model: skill-tanvurlng, system: { masteryLevelBase: 50 } }
  system:
    body:
      structure:
        zones:
