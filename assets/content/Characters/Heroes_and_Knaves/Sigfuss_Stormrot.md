...
- **Harbormaster Aldwin Kaldsteinn**: An official charged with the ordering of the port in Vithgard's capital. Aldwin views Sigfúss as a troublemaker who flouts maritime law and encourages crew insubordination. Their conflicts are frequent and bitter.
- **Captain Ragnar Svartlögr**: A rival sailor who captains a merchant vessel and views Sigfúss as competition for the most prestigious contracts. Ragnar has twice maneuvered to undercut Sigfúss's negotiations through lies and political leverage.
