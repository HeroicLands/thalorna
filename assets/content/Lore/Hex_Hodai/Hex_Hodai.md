...
These oppositions are not merely theoretical. A practitioner deeply attuned to one Eídma finds the opposing Eídma's magic genuinely more difficult to grasp, like trying to think in a language whose grammar contradicts everything they know. The Ordo's training exploits this: by channeling students into a single Eídma early, it accelerates their mastery of that Eídma's magic at the cost of making the opposing Eídma's approach increasingly alien. This is efficient, but it also means that most Ordo-trained mages are fundamentally lopsided—brilliant within their Eídma, and increasingly limited outside it.

### Adjacencies and Accord

If the oppositions define what conflicts within the Sigillum, the _adjacencies_ define what harmonizes. Eídmata that sit beside one another on the hexagram share sympathies—their principles overlap, and practitioners of adjacent Eídmata often find each other's magic intuitive.
...
A mage's training in their Eídma teaches them to recognize their Eídma's current, to attune to it, to draw from it cleanly without disturbing the others. The deeper the training, the cleaner the attunement—and the harder it becomes to attune to any other current. This is the source of the oppositions and adjacencies described above: not perceptual artifacts, but real properties of the Dýnaris itself, manifesting in the practitioner's developing sensitivity to their chosen current.

To a fully trained Pyréthos mage, the world hums with the current of Pyréthos—heat, light, the urge to transform—because they have spent decades attuning to that current. They are not blind to the other Eídmata; they can recognize them when they are present. But the current they draw from, the current they shape, the current that comes to them when they reach for it, is Pyréthos. To shift their attunement to another current is the work of years and is rarely successfully accomplished outside of [[affiliation-kentra|Kentra]].
...
2. **Denial.** "It is not really magic. It is a trick, a debased folk practice, demonic interference, or sleight-of-hand dressed up in foreign costume." The Ordo refuses to recognize it as arcane at all.
...
What the Ordo cannot do—what the framework structurally prevents it from doing—is recognize the foreign tradition as a legitimate alternative carving of a larger reality. The framework does not admit that there _is_ a larger reality. To accept the foreign tradition on its own terms would require dismantling the Héx Hodäi, and that is not an operation the Ordo is institutionally capable of performing.
