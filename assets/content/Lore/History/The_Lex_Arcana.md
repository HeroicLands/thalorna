...
event:
  ...
  summary: >-
    ...
    state as a body and never as men. The Quaesitorium is constituted in the same instrument and a
    clause earlier, its first commission to establish what happened at Alyssa. The six Sodalitates
    begin as six sealed workshops rebuilding the burned corpus, one to each current, sealed from each
    other on the Quaesitorium's order.
  standing: attested
  names:
    - name: the Lex Arcana
...
doctrinally a party to a seven-century-old crime.
