...
event:
  ...
  names:
    - name: The Valley of Seven Towers
      by: lore-flksinale
      gloss: a name only somebody who had been told what they were looking at could have used
  where:
    locus:
      - place-worldthlrn
  who:
  ...
  follows:
    - event: lore-khazararrv
      how: enabled
      note: the seven clans that came together built for all seven together
  accounts:
    - by: lore-flksinale
      says: >-
    ...
    - by: lore-flkkhazar
      says: Nothing. They never speak of Khazártúrn.
      agrees: silent
  unresolved:
...
the ground it stands in, bedded and weathered and faulted and carrying the same strata as the cliff,
because that is what a well-made thing looks like from outside. Everything the Deep Folk have to say
is said inside.

What they said inside took twenty-seven centuries to finish: halls hundreds of feet from floor to
vault, skylights cut through the mountain that dropped moving shafts of daylight onto the floors,
