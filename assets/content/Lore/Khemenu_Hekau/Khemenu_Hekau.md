...
**hekau**, those who hold sacred power; the title of every high priest in the empire—**Wer'Hekau**, "Great of Sacred Power"—names the greatest of them.
...
as classifying a library by the color of the bindings: true of the objects, and silent about what
any of it is for.
...
| --------------------------------------------- | -------------- | --------------------- | --------------------------------------------------------------- |
| **[[affiliation-maatken\|Per-Maat'ken]]**     | **Maat'ken**   | the Truth that Judges | Law, judgment, binding, wards, oaths, the weighing of the heart |
...
**Ren'sesh and Khat'nu are named for the two soul-components the funerary rites already preserve**—the _ren_ that is inscribed and the _khat_ that is embalmed, the one written on every surface and the
...
Kemetían theology is organized around a single tension—order against chaos. **Maat'ken**, the truth
that judges, is what [[lore-maatdty|Má'át]] imposed on the primordial darkness before creation, and it
is the condition under which anything at all can continue to exist: law, judgment, binding, wards,
...
To _practice_ it is a capital matter. The line is not knowledge but use, and the tradition polices it
...
are the ones the temples have trained to recognize it**, and a scholar of the treatises carries a
permanent shadow of suspicion no amount of orthodoxy quite removes. The temples accept this as the
price of a defense that works, and they are not wrong to: the sect that would break the seal on the
...
A hekau trained that way would be understood in Ta'Kheperu as **defective rather than specialized**.
...
- **It is installed rather than cast.** The characteristic Kheperi working is inscribed and stands—seals, curses, wards, and the bound dead set to wake when a chamber is broken. Some have stood for
  six hundred years.
- **It is transferable through labor.** A correct inscription works for whoever set it correctly,
