...
data:
  ...
  governance:
    ...
    summary: >-
      ...
      god, so what structure exists here is the household observance and the ordeal: devotion to
      honest increase—the sown field and the fair measure—guarded by the Nivara-Kshetras, the
      spirits of the fields, and beyond that the Ordeals for Favor, which are undertaken by
    ...
    ranks:
      ...
      - level: 1
        ...
        lore: layfaithfulrnk
        description: >-
          The lay devotee, keeping the household observance of honest increase—the sown field and
          the fair measure—guarded by the Nivara-Kshetras, the spirits of the fields. This is what
    ...
    offices:
      ...
      The Fair Measure: >-
        A year of public measurement—grain, cloth, wine, oil—completed without one complaint of
        short weight from any party.
  commonSkills:
    - mahajaya
    - agri
    - mrcn
